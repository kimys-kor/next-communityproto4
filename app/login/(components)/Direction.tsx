    ...
    <article className="w-full max-w-[900px] mx-auto p-6 bg-white rounded-lg shadow-md">
      <section className="text-center py-6">
        ...
        <p className="mt-4 text-gray-600 text-sm md:text-base leading-relaxed">
          꽁머니팡는 사용자에게 다양한 서비스를 제공하는 플랫폼으로, 로그인
          절차는 매우 간단합니다.
        </p>
        <p className="mt-4 text-gray-600 text-sm md:text-base leading-relaxed">
      ...
      <section className="mt-10">
        ...
        <div className="space-y-6">
          {[
            ...
            "로그인 후에는 꽁머니팡의 다양한 기능을 이용할 수 있습니다. 예를 들어, 사용자 맞춤형 콘텐츠를 제공받거나, 친구와 소통할 수 있는 기능이 있습니다. 또한, 꽁머니팡는 사용자 경험을 최적화하기 위해 지속적으로 업데이트되고 있으며, 새로운 기능이 추가되고 있습니다.",
