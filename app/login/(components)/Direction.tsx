    ...
    <article className="w-full max-w-[900px] mx-auto p-6 bg-white rounded-lg shadow-md">
      <section className="text-center py-6">
        ...
        <p className="mt-4 text-gray-600 text-sm md:text-base leading-relaxed">
          꽁머니팡은 사용자에게 다양한 서비스를 제공하는 플랫폼으로, 로그인
          절차는 매우 간단합니다.
        </p>
        <p className="mt-4 text-gray-600 text-sm md:text-base leading-relaxed">
      ...
      <section className="mt-10">
        ...
        <div className="space-y-6">
          {[
            "먼저, 꽁머니팡 로그인 페이지에 접속합니다. URL은 https://toiso777.com/login입니다. 이 페이지에서는 사용자 이름과 비밀번호를 입력할 수 있는 필드가 있습니다. 만약 계정이 없다면, 회원 가입을 통해 쉽게 계정을 생성할 수 있습니다. 회원 가입 과정은 간단하며, 필요한 정보만 입력하면 됩니다.",
            "로그인 후에는 꽁머니팡의 다양한 기능을 이용할 수 있습니다. 예를 들어, 사용자 맞춤형 콘텐츠를 제공받거나, 친구와 소통할 수 있는 기능이 있습니다. 또한, 꽁머니팡은 사용자 경험을 최적화하기 위해 지속적으로 업데이트되고 있으며, 새로운 기능이 추가되고 있습니다.",
            ...
            "결론적으로, 로그인은 간편하고 안전한 방법으로, 다양한 서비스를 제공받을 수 있는 기회를 제공합니다. 지금 바로 꽁머니팡에 로그인하여 새로운 경험을 시작해 보세요!",
          ].map((text, index) => (
            <div
              key={index}
      ...
      <section className="mt-12 flex flex-col items-center gap-6 text-center">
        ...
        <p className="text-gray-600 text-sm md:text-base leading-relaxed max-w-[700px]">
          꽁머니팡 로그인 페이지는 사용자들이 간단하고 안전하게 다양한 혜택을
          누릴 수 있도록 설계되었습니다. 안심하고 서비스를 이용해보세요!
        </p>
        <Image
          src={talkball}
          alt="추가 설명 이미지"
