...
export async function generateMetadata({
  ...
  if (!boardId) {
    return {
      ...
      openGraph: {
        title: "게시글을 찾을 수 없습니다",
        description: "유효하지 않은 게시글 ID입니다.",
        url: `https://toiso777.com/sport/baseball/${boardId}`,
      },
      twitter: {
  ...
  try {
    ...
    return {
      title:
        "꽁머니팡 야구분석글: " + boardContent.title || "꽁머니팡 야구분석글: ",
      description:
      ...
      openGraph: {
        title:
          "꽁머니팡 야구분석글: " + boardContent.title ||
          "꽁머니팡 야구분석글: ",
        description:
          boardContent.summary ||
          "꽁머니팡에서 스포츠 분석과 관련된 다양한 정보를 확인해보세요.",
        url: `https://ggongpang.com.com/sport/baseball/${boardId}`,
        ...
        images: [
          {
            ...
            width: 800,
            height: 600,
            alt: boardContent.title || "야구분석 이미지",
          },
        ],
        locale: "ko_KR",
        type: "article",
