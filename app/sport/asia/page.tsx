...
export default function Page() {
  ...
  return (
    <div className="flex flex-col gap-3 max-w-[1300px]">
      <Title
        title={pageData.sportAsia.title}
        description={pageData.sportAsia.description}
      />
      <SubMenu />
      <ThreeBanner />
      <div>
      ...
      <h2 className="text-xl font-semibold mt-6 mb-3">아시아축구분석 게시글</h2>
      <BoardContainer typ={3} page={1} size={15} />
    </div>
  );
}
