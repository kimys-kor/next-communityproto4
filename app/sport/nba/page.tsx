...
export default function Page() {
  ...
  return (
    <div className="flex flex-col gap-3 max-w-[1300px]">
      <Title
        title={pageData.sportNba.title}
        description={pageData.sportNba.description}
      />
      <SubMenu />
      <ThreeBanner />
      <div>
      ...
      <h2 className="text-xl font-semibold mt-6 mb-3">NBA분석 게시글</h2>
      <BoardContainer typ={6} page={1} size={15} />
    </div>
  );
}
