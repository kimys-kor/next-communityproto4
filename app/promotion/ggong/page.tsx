...
export const metadata: Metadata = {
  title: "꽁머니 이벤트 | 토토사이트 추천 토이소 - 최신 꽁머니 정보 확인",
  description:
    "토이소에서 제공하는 최신 꽁머니 이벤트 정보를 확인하세요. 다양한 토토사이트의 꽁머니 혜택과 안전한 토토사이트 추천 정보를 얻어가세요.",
  keywords: [
    "꽁머니",
    "꽁머니이벤트",
    "꽁머니홍보",
  ...
  return (
    <div className="flex flex-col gap-3 max-w-[1300px]">
      ...
      <p className="text-gray-600 mb-4">
        ...
        참여해보세요. 토이소가 추천하는 안전한 토토사이트의 특별한 혜택을 놓치지
        마세요.
      </p>
