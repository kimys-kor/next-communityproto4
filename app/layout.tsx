...
export const metadata = {
  ...
  title: "토이소: 먹튀검증 토토사이트 꽁머니 파워볼  커뮤니티 안전놀이터",
  author: "토이소: 먹튀검증 토토사이트 꽁머니 파워볼  커뮤니티 안전놀이터",
  description:
    "토이소는 먹튀검증, 꽁머니 커뮤니티 입니다. 토토사이트, 먹튀 사이트, 안전놀이터, 파워볼, 스팟 정보를 제공합니다. 먹튀 검증 사이트에서 보증하고 추천하는 메이저 사이트를 확인하세요.",
  keywords:
    "토이소, 먹튀검증, 꽁머니, 토토사이트, 메이저놀이터, 메이저사이트, 안전한놀이터, 먹튀사이트, 프로토, 승무패, 스포츠토토, 파워볼",
  openGraph: {
    type: "website",
    locale: "ko_KR",
