...
export const metadata = {
  ...
  title:
    "토토사이트 모음 추천 BEST TOP20 - 2025 안전놀이터 및 메이저 사이트 꽁머니 모음​ 가이드 토이소",
  author: "토이소: 먹튀검증 토토사이트 꽁머니 파워볼 커뮤니티 안전놀이터",
  description:
    "토토사이트를 선택함에 있어서 먹튀 피해가 지속하여 증가하고 있습니다. 피해를 막기 위해 2025년 3월 토토사이트 추천 모음 BEST 20위를 소개합니다. 토이소에서 안전놀이터, 메이저놀이터, 먹튀검증과, 먹튀사이트의 최신 동향을 지금 확인하세요.",
  keywords:
    "토이소, 토토사이트, 토토사이트 추천, 먹튀검증, 꽁머니, 안전놀이터, 메이저사이트, 파워볼, 스포츠토토, 먹튀사이트, 안전한놀이터, 베팅사이트, 추천토토사이트, TOP20, 2025, 메이저놀이터, 토토 추천, 안전토토, 먹튀검증업체",
  openGraph: {
    type: "website",
    locale: "ko_KR",
